...
if __name__ == '__main__':
    ...
    parser.add_argument('--ground_truth_path', type=Path, default=Path('ucf101_json/ucf101_01.json'))
    parser.add_argument('--result_path', type=Path, default=Path('val.json'))
